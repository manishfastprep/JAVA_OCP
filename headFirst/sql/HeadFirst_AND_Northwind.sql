...
DROP TABLE movie_table_initial;
CREATE TABLE movie_table_initial
(
    ...
    cartoom char(1) NOT NULL,
    purchased date NOT NULL,
    PRIMARY KEY (movie_id)
);

select * from movie_table_initial;

INSERT INTO `gregs_list`.`movie_table_initial`
(`title`,`rating`,`drama`,`comedy`,`action`,`gore`,`scifi`,`for_kids`,`cartoom`,`purchased`)
VALUES
('title1','G','F','T','F','F','F','T','T','2002-3-6'),
('title2','R','F','F','T','T','F','F','F','2001-2-5'),
('title3','G','T','F','F','F','F','F','F','1999-11-20'),
('title4','R','F','T','F','F','F','F','F','2003-4-19'),
('title5','R','F','F','T','T','F','F','F','2003-4-19'),
('title6','G','T','F','F','F','F','F','F','2001-2-5')
;
create table test_sql_order
(
	test_chars char(1)
); 

select * from test_sql_order;
DELETE from test_sql_order where true;
INSERT into test_sql_order
VALUES
(0),
    (1),
    (2),
